...
import 'package:unir/screens/admin_screen.dart';
...
class AdminDeleteScreen extends StatelessWidget {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Host ID: $id', style: TextStyle(fontSize: 18,
                            fontFamily: 'OpenSans')),
                        SizedBox(height: 10),
  ...
  Future<void> _deleteEvent() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('events').doc(latestEventId).delete();
